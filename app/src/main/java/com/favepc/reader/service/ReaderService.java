...
public class ReaderService {
    ...
    public byte[] setPower(String value) {
        return this.command_("N1,").data_(ReaderService.Format.makesUpZero(value.toUpperCase(), 2)).commit();
    }
    ...
    public byte[] setGPIO(String value) {
        return this.command_("N7,").data_(ReaderService.Format.makesUpZero(value.toUpperCase(), 2)).commit();
    }
